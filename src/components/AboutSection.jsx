...
const AboutSection = () => {
  return (
    <section className='pt-24 p-5 lg:px-40 min-h-screen flex flex-col lg:flex-row gap-5 lg:py-20 w-full' id='about'>
        ...
        <div className='flex flex-col lg:flex-row gap-5'>
            <div className='w-full h-full lg:w-[35%]'>
                <WhiteBlock
                    elements={
                        ...
                        width={1000} 
                        height={1000}
                        className='md:h-full sm:w-full sm:h-full scale-[1.1]'
                        />
                    }
                    css='w-full h-full overflow-hidden'
                />
            </div>
            <div className='flex flex-col gap-5 w-full lg:w-[65%]'>
                <WhiteBlock 
                    elements={
                        <div className='flex justify-between items-center'>
                            <div>
                                <h1 className='text-3xl sm:text-4xl lg:mb-4 lg:text-7xl'>About Me</h1>
                                <span className='text-sm lg:text-4xl mt-5'>UIUX/Graphics Designer</span>
                            </div>
                            <Image src='/images/03 shaka.png' width={1000} height={1000} className='scale-x-[-1] w-20 h-20 lg:w-40 lg:h-40'/>
                        </div>
                    }
                ...
                <WhiteBlock 
                    elements={
                        <p className='text-sm md:text-xl'>Hi, My name is Prashant. I am a passionate designer filled with creative juices and a designer bookworm. Master of graphics and intern of UIUX.</p>
                    }
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-5 max-w-fit'>
                    <WhiteBlock 
                        ...
                        css='p-8 lg:w-auto w-full'
                    />
                    <WhiteBlock 
                        elements={
                            <Link href='/' className='text-xl lg:text-2xl underline'>Know more</Link>
                        }
                        // css=' rounded-2xl lg:px-12 lg:py-10'
                        css='p-5 lg:px-12 lg:py-10 text-center'
                    />
                </div>
            </div>
        </div>
